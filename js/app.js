...
function submitForm() {
    ...
    submit.addEventListener("click", async function() {
        ...
        await fetch('http://census.daybreakgames.com/s:example/get/ps2:v2/character/?name.first_lower=' + name + '&c:resolve=faction')
            .then(response =>
                response.json())
            .then(async data => {
                console.log(data);
                ...
                showHeader();
                await fetch('http://census.daybreakgames.com/s:example/get/ps2:v2/characters_stat_history/?character_id=' + characterid + '&c:limit=50&c:sort=all_time:-1')
                    .then(response =>
                        response.json())
                    .then(data => {
                        console.log(data);
                ...
                await fetch('http://census.daybreakgames.com/get/ps2:v2/experience_rank/?rank=' + data.character_list[0].battle_rank.value + '&c:show=rank,' + data.character_list[0].faction.code_tag.toLowerCase() + '')
                    .then(response =>
                        response.json())
                    .then(data => {
                        console.log(data);
...
async function getAPI() {
    ...
    await fetch('http://census.daybreakgames.com/s:example/get/ps2:v2/characters_stat_history/?c:limit=10&stat_name=score&c:sort=all_time:-1&c:join=character^inject_at:character^show:name')
        .then(response =>
            response.json())
        .then(data => {
        ...
        .catch(error => console.error(error))
    await fetch('http://census.daybreakgames.com/s:example/get/ps2:v2/characters_stat_history/?c:limit=10&stat_name=kills&c:sort=all_time:-1&c:join=character^inject_at:character^show:name')
        .then(response =>
            response.json())
        .then(data => {
